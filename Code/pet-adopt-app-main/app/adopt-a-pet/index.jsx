...
export default function AddAdopter() {
  ...
  const onSubmit = () => {
    ...
    const regex = /\D/g;  // This regex matches any non-digit character
if (formData.phoneNumber.length < 10 || regex.test(formData.phoneNumber)) {
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    padding: 20,
    paddingBottom: 50, // To ensure the last element is not covered
    height: 1500
  },
  headerTitle: {
